...
def main():
    ...
    parser.add_argument(
        ...
        metavar="filename",
        type=str,
        help="Filename to save the figure to",
        required=True,
    )
    parser.add_argument(
        "--font_scale",
    ...
    parser.add_argument(
        ...
        metavar="dataset",
        type=str,
        help="Dataset to draw boxplot from",
        required=True,
    )
    parser.add_argument(
        "--column",
    ...
    if "dataset" in args and args.column == None:
        print(list(df))
        sys.exit(0)
    ...
    with sns.plotting_context(
        ...
        rc={"lines.linewidth": args.font_scale, "grid.linewidth": args.font_scale},
    ):
